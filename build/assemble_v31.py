...
WORK = f'{V9}/apk_work_v31'
FINAL = f'{V9}/out/Byte-Launcher-v31-item-visible-fix.apk'
...
candidates = glob.glob('/home/user/.cache/**/zipalign', recursive=True)
zipalign = candidates[0] if candidates else 'zipalign'
