...
PCK=f'{V9}/out/Byte-v47.pck'
PB='/home/user/.cache/pck_v10/assets/project.binary'
if not os.path.exists(PB):
    PB='/tmp/v10_extract/assets/project.binary'
    if not os.path.exists(PB):
        # Find project.binary from extracted APK
        import glob
        cands=glob.glob('/home/user/.cache/pck_v10/project.binary')
        if cands:
            PB=cands[0]
SRC='/home/user/.cache/pck_v10_merged/.godot/mono/publish/arm64'
if not os.path.exists(SRC):
    SRC='/home/user/.cache/pck_v10/.godot/mono/publish/arm64'
NEW=f'{V9}/proj/.godot/mono/temp/bin/Debug/DesktopPets.dll'
WORK=f'{V9}/apk_work_v47'
FINAL=f'{V9}/out/Byte-Launcher-v47-deepdive-bit-top-small.apk'
